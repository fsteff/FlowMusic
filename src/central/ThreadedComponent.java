...
/**
 * Base class for components. The constructor starts a thread that handles the
 * incoming messages.
 * 
 * @author Stefan Fixl
 */
public abstract class ThreadedComponent {
	 ...
	 * @throws InterruptedException
	 */
	protected void sendMessage(Component recipient, JSONObject msg) throws InterruptedException {
	 ...
	 *            JSONObject containing the message
	 * @param onAnswer
	 *            Callback function that will be called instead of onMessage
	 * @throws InterruptedException
	 * @throws Exception
	 */
